package com.tom_e_white.disq.impl.formats.sam;
 ...
 * {@link com.tom_e_white.disq.impl.formats.bam.BamSink}, {@link
 * com.tom_e_white.disq.impl.formats.cram.CramSink}, and {@link SamSink} since it avoids the cost of
 * merging the headerless files at the end, however multiple files may not be as easy to consume for
 * some external systems.
 *
 * @see com.tom_e_white.disq.impl.formats.bam.BamSink
 * @see com.tom_e_white.disq.impl.formats.cram.CramSink
 * @see SamSink
 * @see HtsjdkReadsRdd
 */
