...
import static com.tom_e_white.disq.AnySamTestUtil.countReads;
import static com.tom_e_white.disq.VcfTestUtil.countVariants;
...
public class RealWorldFilesIT extends BaseTest {
  ...
  public void testReads(String inputFile, String cramReferenceFile, int splitSize, boolean useNio)
    ...
    int expectedCount = countReads(inputPath, refPath, null, ValidationStringency.SILENT);
